...
La solicitud debe incluir en el `body` un objeto `JSON` en donde se indiquen los siguientes parametros: IdUsuario, IdTipoIncidente, Descripcion y los Objetos a Indemnizar
